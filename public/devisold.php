...
<?php 
    // include __DIR__ . '/Dashboard/including/config.php';
    ...
    $ad = Contact::getAllDetails(array('id_contact'=>$contact->id_contact, 'type_detail'=>'1'));
    $enf = Contact::getAllDetails(array('id_contact'=>$contact->id_contact, 'type_detail'=>'2'));
    $bb = Contact::getAllDetails(array('id_contact'=>$contact->id_contact, 'type_detail'=>'3'));
    ...
    $infchs = Chambres::getAll(array('id_contact'=>$contact->id_contact));
    $addTot = 0;
    $descch = '';
    $supch = '';
    $totsupch = 0;
    ...
    $htmldetails ='';
    $alldetails = Contact::getAllDetails(array('id_contact'=>$contact->id_contact));
...
<?php
    ...
    if (isset($_GET['key'])) {
        ...
        $curusr = Contact::findOne(array('c.id_contact' => $idc, 'c.codekey ' => $codekey));
    }
...
<script src="Dashboard/jscript/vendor/jquery-1.12.0.min.js"></script>
    ...
    <body>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                    ...
                    <div class="col-md-8 col-md-offset-2 col-sm-12">
                        <form onsubmit="return false;" class="form-horizontal" method="post" action="pubajax.php" id="formulairedevis">
                            <!-- Article Header -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer"> 
                            <input type="hidden" id="idct" name="idct" value="<?php echo $contact ? $contact->id_contact : '0'; ?>" />
        ...
        <footer class="clearfix">
            <div class="pull-left">
                <span id="y-copy-right"></span> &copy; <?=date('Y')?> <a href="#" target="_blank">MH palace</a>
            </div>
        </footer>
        <!-- END Footer -->
        ...
        <script src="Dashboard/jscript/app.js"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#btsign').click(function() {
                    ...
                    HoldOn.open();
                    $.post('pubajax.php', {action:'enreg-sign',idct:$('#idct').val(), codekey:$('#codekey').val(), sign:signaturePad.toDataURL()}, function(resp) {
                        HoldOn.close();
                        if (resp.responseAjax == 'SUCCESS') {
